...
def test_get_csv_to_table_mapping():
    """Test the get_csv_to_table_mapping function."""
    csv_to_table_mapping = get_csv_to_table_mapping()
    assert len(csv_to_table_mapping) == 9
    assert csv_to_table_mapping["olist_customers_dataset.csv"] == "olist_customers"
