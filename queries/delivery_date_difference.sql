...
SELECT
    ...
    CAST(AVG(julianday(STRFTIME('%Y-%m-%d',o.order_estimated_delivery_date)) - julianday(STRFTIME('%Y-%m-%d', o.order_delivered_customer_date))) AS INTERGER) AS Delivery_Difference
FROM olist_orders o
